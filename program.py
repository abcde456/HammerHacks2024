...
sem1Title = ct.CTkLabel(app, text="Semester 1:", font=h2Font)
sem1Title.grid(row=1, column=1, pady=20)
...
sem2Title = ct.CTkLabel(app, text="Semester 2:", font=h2Font)
sem2Title.grid(row=3, column=1, pady=20)
